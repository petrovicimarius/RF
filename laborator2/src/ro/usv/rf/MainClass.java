...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		for (int featureIndex = 0; featureIndex < numberOfFeatures; featureIndex++)
		{
			...
			System.out.println("Feature average is : " + featureAverages[featureIndex]);
			
			featureDispersions[featureIndex] = StatisticsUtils.calculateFeatureDispersion(feature, featureAverages[featureIndex]);
		...
		double covariance = StatisticsUtils.calculateCovariance(featureList.get(feature1Index), featureList.get(feature2Index), 
				featureAverages[feature1Index],  featureAverages[feature2Index]);
